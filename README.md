...
- [특갤툰) 수학자도 이제 다 따따 잇이라고?!](https://gall.dcinside.com/thesingularity/1413100) — 2026-09-12 게시, 16페이지.
- AGY/Gemini가 집필·연출을 맡고 Codex가 편집·제작을 연결했습니다. 생성 실행 기록은 ima2-gen의 `gpt-6-astra / medium / direct` 경로이며, 콘티 협업 모델은 `gemini-3.8-flash-high`입니다.
- 의도와 WHY를 이어주는 협업, 컷 배치 퇴고, 정보·묘사의 집중과 여백, 캐릭터 얼굴을 붙인 내레이션을 반영한 최신 결과물입니다.

현재 결과물을 보려면 이 작품부터 확인하세요. 아래 사례는 이전 세대의 제작 과정과 대화 기록을 살펴보는 자료로 구분합니다.
...
- [당시 게시 결과물: 특갤툰) AGI 떴냐?!?!](https://gall.dcinside.com/thesingularity/1347863)

이 사례는 5페이지·13컷의 대화형 정보 개그툰을 17개 독립 후보로 생성하고, 사람이 페이지별 후보를 골라 완성한 기록입니다. AGY/Gemini와 v1 콘티를 만들고 Codex가 검수·수정한 과정, 장면 관계 판단과 입력 검증·실행의 책임을 구분한 과정을 보존합니다. 모델과 제작 지침이 달라진 시기의 사례이므로 최신 결과와 세대를 나누어 읽을 수 있게 두었습니다.
